...
export const MODEL_OPTIONS: ModelOption[] = [
  {
    ...
    name: "GPT-5.6 Sol",
    provider: "OpenAI",
    note: "$5 in / $30 out per 1m",
  },
  {
    id: "gpt-5.6-terra",
    name: "GPT-5.6 Terra",
    provider: "OpenAI",
    note: "$2.50 in / $15 out per 1m",
  },
  {
    id: "gpt-5.6-luna",
    name: "GPT-5.6 Luna",
    provider: "OpenAI",
    note: "$1 in / $6 out per 1m",
  },
  {
    id: "gpt-5.4-mini",
    name: "GPT-5.4 mini",
    provider: "OpenAI",
    note: "$0.75 in / $4.50 out per 1m",
  },
  {
    id: "gpt-5.4-nano",
    name: "GPT-5.4 nano",
    provider: "OpenAI",
    note: "$0.20 in / $1.25 out per 1m",
  },
  {
    id: "gpt-5-mini",
    name: "GPT-5 mini",
    provider: "OpenAI",
    note: "$0.25 in / $2 out per 1m",
  },
  {
    id: "gpt-5-nano",
    name: "GPT-5 nano",
    provider: "OpenAI",
    note: "$0.05 in / $0.40 out per 1m",
  },
  {
    id: "claude-fable-5",
    name: "Claude Fable 5",
